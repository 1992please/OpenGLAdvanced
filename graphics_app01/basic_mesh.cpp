...
bool BasicMesh::LoadMesh(const char* Filename)
{
	...
	if (file.load())
	{
		...
		file.GetStaticMesh(lCachedMesh);
		// Init Meshes................................
		...
		if (lNormals)
		{
			...
			glVertexAttribPointer(TEX_COORD_LOCATION, NORMAL_STRIDE, GL_FLOAT, GL_FALSE, 0, 0);
		}
		...
		if (lUVs)
		{
			...
			glVertexAttribPointer(NORMAL_LOCATION, UV_STRIDE, GL_FLOAT, GL_FALSE, 0, 0);
		}
...
bool BasicMesh::InitFromCachedMesh(const CachedMesh* Mesh)
{
	return false;
}
